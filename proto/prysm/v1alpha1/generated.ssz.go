...
// Hash: 59496049a48ce8c5419e7242c30a35a2f0108402b2bceaf571f99def153ccabe
package eth
...
func (a *AggregateAttestationAndProof) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'AggregatorIndex'
	a.AggregatorIndex = github_com_prysmaticlabs_prysm_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[0:8]))
...
func (a *AttestationData) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'Slot'
	a.Slot = github_com_prysmaticlabs_prysm_consensus_types_primitives.Slot(ssz.UnmarshallUint64(buf[0:8]))

	// Field (1) 'CommitteeIndex'
	a.CommitteeIndex = github_com_prysmaticlabs_prysm_consensus_types_primitives.CommitteeIndex(ssz.UnmarshallUint64(buf[8:16]))
...
func (c *Checkpoint) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'Epoch'
	c.Epoch = github_com_prysmaticlabs_prysm_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[0:8]))
...
func (b *BeaconBlock) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'Slot'
	b.Slot = github_com_prysmaticlabs_prysm_consensus_types_primitives.Slot(ssz.UnmarshallUint64(buf[0:8]))

	// Field (1) 'ProposerIndex'
	b.ProposerIndex = github_com_prysmaticlabs_prysm_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[8:16]))
...
func (v *VoluntaryExit) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'Epoch'
	v.Epoch = github_com_prysmaticlabs_prysm_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[0:8]))

	// Field (1) 'ValidatorIndex'
	v.ValidatorIndex = github_com_prysmaticlabs_prysm_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[8:16]))
...
// MarshalSSZ ssz marshals the SignedBeaconBlockWithBlobKZGs object
func (s *SignedBeaconBlockWithBlobKZGs) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(s)
}

// MarshalSSZTo ssz marshals the SignedBeaconBlockWithBlobKZGs object to a target array
func (s *SignedBeaconBlockWithBlobKZGs) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(100)
	...
	dst = ssz.WriteOffset(dst, offset)
	if s.Block == nil {
		s.Block = new(BeaconBlockWithBlobKZGs)
	}
	offset += s.Block.SizeSSZ()
...
// UnmarshalSSZ ssz unmarshals the SignedBeaconBlockWithBlobKZGs object
func (s *SignedBeaconBlockWithBlobKZGs) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 100 {
		return ssz.ErrSize
...
// SizeSSZ returns the ssz encoded size in bytes for the SignedBeaconBlockWithBlobKZGs object
func (s *SignedBeaconBlockWithBlobKZGs) SizeSSZ() (size int) {
	size = 100
...
// HashTreeRoot ssz hashes the SignedBeaconBlockWithBlobKZGs object
func (s *SignedBeaconBlockWithBlobKZGs) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(s)
}

// HashTreeRootWith ssz hashes the SignedBeaconBlockWithBlobKZGs object with a hasher
func (s *SignedBeaconBlockWithBlobKZGs) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
...
// MarshalSSZ ssz marshals the SignedBlindedBeaconBlockWithBlobKZGs object
func (s *SignedBlindedBeaconBlockWithBlobKZGs) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(s)
}

// MarshalSSZTo ssz marshals the SignedBlindedBeaconBlockWithBlobKZGs object to a target array
func (s *SignedBlindedBeaconBlockWithBlobKZGs) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(100)
	...
	dst = ssz.WriteOffset(dst, offset)
	if s.Block == nil {
		s.Block = new(BlindedBeaconBlockWithBlobKZGs)
	}
	offset += s.Block.SizeSSZ()
...
// UnmarshalSSZ ssz unmarshals the SignedBlindedBeaconBlockWithBlobKZGs object
func (s *SignedBlindedBeaconBlockWithBlobKZGs) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 100 {
		return ssz.ErrSize
...
// SizeSSZ returns the ssz encoded size in bytes for the SignedBlindedBeaconBlockWithBlobKZGs object
func (s *SignedBlindedBeaconBlockWithBlobKZGs) SizeSSZ() (size int) {
	size = 100
...
// HashTreeRoot ssz hashes the SignedBlindedBeaconBlockWithBlobKZGs object
func (s *SignedBlindedBeaconBlockWithBlobKZGs) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(s)
}

// HashTreeRootWith ssz hashes the SignedBlindedBeaconBlockWithBlobKZGs object with a hasher
func (s *SignedBlindedBeaconBlockWithBlobKZGs) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
...
// MarshalSSZ ssz marshals the BeaconBlockWithBlobKZGs object
func (b *BeaconBlockWithBlobKZGs) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(b)
}

// MarshalSSZTo ssz marshals the BeaconBlockWithBlobKZGs object to a target array
func (b *BeaconBlockWithBlobKZGs) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(84)
	...
	dst = ssz.WriteOffset(dst, offset)
	if b.Body == nil {
		b.Body = new(BeaconBlockBodyWithBlobKZGs)
	}
	offset += b.Body.SizeSSZ()
...
// UnmarshalSSZ ssz unmarshals the BeaconBlockWithBlobKZGs object
func (b *BeaconBlockWithBlobKZGs) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 84 {
		return ssz.ErrSize
...
// SizeSSZ returns the ssz encoded size in bytes for the BeaconBlockWithBlobKZGs object
func (b *BeaconBlockWithBlobKZGs) SizeSSZ() (size int) {
	size = 84
...
// HashTreeRoot ssz hashes the BeaconBlockWithBlobKZGs object
func (b *BeaconBlockWithBlobKZGs) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(b)
}

// HashTreeRootWith ssz hashes the BeaconBlockWithBlobKZGs object with a hasher
func (b *BeaconBlockWithBlobKZGs) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
...
// MarshalSSZ ssz marshals the BlindedBeaconBlockWithBlobKZGs object
func (b *BlindedBeaconBlockWithBlobKZGs) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(b)
}

// MarshalSSZTo ssz marshals the BlindedBeaconBlockWithBlobKZGs object to a target array
func (b *BlindedBeaconBlockWithBlobKZGs) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(84)
	...
	dst = ssz.WriteOffset(dst, offset)
	if b.Body == nil {
		b.Body = new(BlindedBeaconBlockBodyWithBlobKZGs)
	}
	offset += b.Body.SizeSSZ()
...
// UnmarshalSSZ ssz unmarshals the BlindedBeaconBlockWithBlobKZGs object
func (b *BlindedBeaconBlockWithBlobKZGs) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 84 {
		return ssz.ErrSize
...
// SizeSSZ returns the ssz encoded size in bytes for the BlindedBeaconBlockWithBlobKZGs object
func (b *BlindedBeaconBlockWithBlobKZGs) SizeSSZ() (size int) {
	size = 84
...
// HashTreeRoot ssz hashes the BlindedBeaconBlockWithBlobKZGs object
func (b *BlindedBeaconBlockWithBlobKZGs) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(b)
}

// HashTreeRootWith ssz hashes the BlindedBeaconBlockWithBlobKZGs object with a hasher
func (b *BlindedBeaconBlockWithBlobKZGs) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
...
// MarshalSSZ ssz marshals the BeaconBlockBodyWithBlobKZGs object
func (b *BeaconBlockBodyWithBlobKZGs) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(b)
}

// MarshalSSZTo ssz marshals the BeaconBlockBodyWithBlobKZGs object to a target array
func (b *BeaconBlockBodyWithBlobKZGs) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(388)
	...
	// Field (10) 'BlobKzgs'
	if len(b.BlobKzgs) > 16777216 {
		err = ssz.ErrListTooBig
		return
	}
	for ii := 0; ii < len(b.BlobKzgs); ii++ {
		if len(b.BlobKzgs[ii]) != 48 {
			err = ssz.ErrBytesLength
			return
		}
		dst = append(dst, b.BlobKzgs[ii]...)
	}

	return
}

// UnmarshalSSZ ssz unmarshals the BeaconBlockBodyWithBlobKZGs object
func (b *BeaconBlockBodyWithBlobKZGs) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 388 {
		return ssz.ErrSize
	...
	{
		buf = tail[o10:]
		num, err := ssz.DivideInt2(len(buf), 48, 16777216)
		if err != nil {
			return err
		}
		b.BlobKzgs = make([][]byte, num)
		for ii := 0; ii < num; ii++ {
			if cap(b.BlobKzgs[ii]) == 0 {
				b.BlobKzgs[ii] = make([]byte, 0, len(buf[ii*48:(ii+1)*48]))
			}
			b.BlobKzgs[ii] = append(b.BlobKzgs[ii], buf[ii*48:(ii+1)*48]...)
		}
	}
	return err
}

// SizeSSZ returns the ssz encoded size in bytes for the BeaconBlockBodyWithBlobKZGs object
func (b *BeaconBlockBodyWithBlobKZGs) SizeSSZ() (size int) {
	size = 388
	...
	// Field (10) 'BlobKzgs'
	size += len(b.BlobKzgs) * 48

	return
}

// HashTreeRoot ssz hashes the BeaconBlockBodyWithBlobKZGs object
func (b *BeaconBlockBodyWithBlobKZGs) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(b)
}

// HashTreeRootWith ssz hashes the BeaconBlockBodyWithBlobKZGs object with a hasher
func (b *BeaconBlockBodyWithBlobKZGs) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
	...
	// Field (10) 'BlobKzgs'
	{
		...
		hh.MerkleizeWithMixin(subIndx, numItems, ssz.CalculateLimit(16777216, numItems, 0))
	}
...
// MarshalSSZ ssz marshals the BlindedBeaconBlockBodyWithBlobKZGs object
func (b *BlindedBeaconBlockBodyWithBlobKZGs) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(b)
}

// MarshalSSZTo ssz marshals the BlindedBeaconBlockBodyWithBlobKZGs object to a target array
func (b *BlindedBeaconBlockBodyWithBlobKZGs) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(388)
...
// UnmarshalSSZ ssz unmarshals the BlindedBeaconBlockBodyWithBlobKZGs object
func (b *BlindedBeaconBlockBodyWithBlobKZGs) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 388 {
		return ssz.ErrSize
...
// SizeSSZ returns the ssz encoded size in bytes for the BlindedBeaconBlockBodyWithBlobKZGs object
func (b *BlindedBeaconBlockBodyWithBlobKZGs) SizeSSZ() (size int) {
	size = 388
...
// HashTreeRoot ssz hashes the BlindedBeaconBlockBodyWithBlobKZGs object
func (b *BlindedBeaconBlockBodyWithBlobKZGs) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(b)
}

// HashTreeRootWith ssz hashes the BlindedBeaconBlockBodyWithBlobKZGs object with a hasher
func (b *BlindedBeaconBlockBodyWithBlobKZGs) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
...
func (b *BlobsSidecar) UnmarshalSSZ(buf []byte) error {
	...
	// Field (1) 'BeaconBlockSlot'
	b.BeaconBlockSlot = github_com_prysmaticlabs_prysm_consensus_types_primitives.Slot(ssz.UnmarshallUint64(buf[32:40]))
...
// MarshalSSZ ssz marshals the SignedBlobsSidecar object
func (s *SignedBlobsSidecar) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(s)
}

// MarshalSSZTo ssz marshals the SignedBlobsSidecar object to a target array
func (s *SignedBlobsSidecar) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(100)
...
// UnmarshalSSZ ssz unmarshals the SignedBlobsSidecar object
func (s *SignedBlobsSidecar) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 100 {
		return ssz.ErrSize
...
// SizeSSZ returns the ssz encoded size in bytes for the SignedBlobsSidecar object
func (s *SignedBlobsSidecar) SizeSSZ() (size int) {
	size = 100
...
// HashTreeRoot ssz hashes the SignedBlobsSidecar object
func (s *SignedBlobsSidecar) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(s)
}

// HashTreeRootWith ssz hashes the SignedBlobsSidecar object with a hasher
func (s *SignedBlobsSidecar) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
...
// MarshalSSZ ssz marshals the BlobsWithKzgs object
func (b *BlobsWithKzgs) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(b)
}

// MarshalSSZTo ssz marshals the BlobsWithKzgs object to a target array
func (b *BlobsWithKzgs) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(8)
...
// UnmarshalSSZ ssz unmarshals the BlobsWithKzgs object
func (b *BlobsWithKzgs) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 8 {
		return ssz.ErrSize
...
// SizeSSZ returns the ssz encoded size in bytes for the BlobsWithKzgs object
func (b *BlobsWithKzgs) SizeSSZ() (size int) {
	size = 8
...
// HashTreeRoot ssz hashes the BlobsWithKzgs object
func (b *BlobsWithKzgs) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(b)
}

// HashTreeRootWith ssz hashes the BlobsWithKzgs object with a hasher
func (b *BlobsWithKzgs) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
...
// MarshalSSZ ssz marshals the AggregatedPoly object
func (a *AggregatedPoly) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(a)
}

// MarshalSSZTo ssz marshals the AggregatedPoly object to a target array
func (a *AggregatedPoly) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(52)

	// Offset (0) 'AggregatedPoly'
	dst = ssz.WriteOffset(dst, offset)
	offset += len(a.AggregatedPoly) * 48

	// Field (1) 'AggregatedPolyCommitment'
	if len(a.AggregatedPolyCommitment) != 48 {
		err = ssz.ErrBytesLength
		return
	}
	dst = append(dst, a.AggregatedPolyCommitment...)

	// Field (0) 'AggregatedPoly'
	if len(a.AggregatedPoly) > 16 {
		err = ssz.ErrListTooBig
		return
	}
	for ii := 0; ii < len(a.AggregatedPoly); ii++ {
		if len(a.AggregatedPoly[ii]) != 48 {
			err = ssz.ErrBytesLength
			return
		}
		dst = append(dst, a.AggregatedPoly[ii]...)
	}

	return
}

// UnmarshalSSZ ssz unmarshals the AggregatedPoly object
func (a *AggregatedPoly) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 52 {
		return ssz.ErrSize
	...
	// Field (1) 'AggregatedPolyCommitment'
	if cap(a.AggregatedPolyCommitment) == 0 {
		a.AggregatedPolyCommitment = make([]byte, 0, len(buf[4:52]))
	}
	a.AggregatedPolyCommitment = append(a.AggregatedPolyCommitment, buf[4:52]...)
	...
	// Field (0) 'AggregatedPoly'
	{
		...
		a.AggregatedPoly = make([][]byte, num)
		for ii := 0; ii < num; ii++ {
			if cap(a.AggregatedPoly[ii]) == 0 {
				a.AggregatedPoly[ii] = make([]byte, 0, len(buf[ii*48:(ii+1)*48]))
			}
			a.AggregatedPoly[ii] = append(a.AggregatedPoly[ii], buf[ii*48:(ii+1)*48]...)
		}
	}
	return err
}

// SizeSSZ returns the ssz encoded size in bytes for the AggregatedPoly object
func (a *AggregatedPoly) SizeSSZ() (size int) {
	size = 52

	// Field (0) 'AggregatedPoly'
	size += len(a.AggregatedPoly) * 48

	return
}

// HashTreeRoot ssz hashes the AggregatedPoly object
func (a *AggregatedPoly) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(a)
}

// HashTreeRootWith ssz hashes the AggregatedPoly object with a hasher
func (a *AggregatedPoly) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
	...
	// Field (0) 'AggregatedPoly'
	{
		...
		subIndx := hh.Index()
		for _, i := range a.AggregatedPoly {
			if len(i) != 48 {
				err = ssz.ErrBytesLength
				return
			}
		...
		numItems := uint64(len(a.AggregatedPoly))
		hh.MerkleizeWithMixin(subIndx, numItems, ssz.CalculateLimit(16, numItems, 0))
	}
	...
	hh.PutBytes(a.AggregatedPolyCommitment)
...
func (b *BeaconState) UnmarshalSSZ(buf []byte) error {
	...
	// Field (2) 'Slot'
	b.Slot = github_com_prysmaticlabs_prysm_consensus_types_primitives.Slot(ssz.UnmarshallUint64(buf[40:48]))
...
func (f *Fork) UnmarshalSSZ(buf []byte) error {
	...
	// Field (2) 'Epoch'
	f.Epoch = github_com_prysmaticlabs_prysm_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[8:16]))
...
func (p *PendingAttestation) UnmarshalSSZ(buf []byte) error {
	...
	// Field (2) 'InclusionDelay'
	p.InclusionDelay = github_com_prysmaticlabs_prysm_consensus_types_primitives.Slot(ssz.UnmarshallUint64(buf[132:140]))

	// Field (3) 'ProposerIndex'
	p.ProposerIndex = github_com_prysmaticlabs_prysm_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[140:148]))
...
func (s *SyncAggregatorSelectionData) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'Slot'
	s.Slot = github_com_prysmaticlabs_prysm_consensus_types_primitives.Slot(ssz.UnmarshallUint64(buf[0:8]))
...
func (s *Status) UnmarshalSSZ(buf []byte) error {
	...
	// Field (2) 'FinalizedEpoch'
	s.FinalizedEpoch = github_com_prysmaticlabs_prysm_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[36:44]))
	...
	// Field (4) 'HeadSlot'
	s.HeadSlot = github_com_prysmaticlabs_prysm_consensus_types_primitives.Slot(ssz.UnmarshallUint64(buf[76:84]))
...
func (b *BeaconBlocksByRangeRequest) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'StartSlot'
	b.StartSlot = github_com_prysmaticlabs_prysm_consensus_types_primitives.Slot(ssz.UnmarshallUint64(buf[0:8]))
...
func (e *ENRForkID) UnmarshalSSZ(buf []byte) error {
	...
	// Field (2) 'NextForkEpoch'
	e.NextForkEpoch = github_com_prysmaticlabs_prysm_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[8:16]))
...
func (s *SyncCommitteeMessage) UnmarshalSSZ(buf []byte) error {
	...
	// Field (2) 'ValidatorIndex'
	s.ValidatorIndex = github_com_prysmaticlabs_prysm_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[40:48]))
...
func (c *ContributionAndProof) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'AggregatorIndex'
	c.AggregatorIndex = github_com_prysmaticlabs_prysm_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[0:8]))
...
func (v *Validator) UnmarshalSSZ(buf []byte) error {
	...
	// Field (4) 'ActivationEligibilityEpoch'
	v.ActivationEligibilityEpoch = github_com_prysmaticlabs_prysm_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[89:97]))

	// Field (5) 'ActivationEpoch'
	v.ActivationEpoch = github_com_prysmaticlabs_prysm_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[97:105]))

	// Field (6) 'ExitEpoch'
	v.ExitEpoch = github_com_prysmaticlabs_prysm_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[105:113]))

	// Field (7) 'WithdrawableEpoch'
	v.WithdrawableEpoch = github_com_prysmaticlabs_prysm_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[113:121]))
