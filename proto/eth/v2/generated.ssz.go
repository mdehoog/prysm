...
// Hash: e792b396681307ec363519a45c91a15c634fa69c45aaf9c463a79d5b4c52af1d
package eth
...
// MarshalSSZ ssz marshals the SignedBeaconBlockEip4844 object
func (s *SignedBeaconBlockEip4844) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(s)
}

// MarshalSSZTo ssz marshals the SignedBeaconBlockEip4844 object to a target array
func (s *SignedBeaconBlockEip4844) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(100)
	...
	dst = ssz.WriteOffset(dst, offset)
	if s.Message == nil {
		s.Message = new(BeaconBlockEip4844)
	}
	offset += s.Message.SizeSSZ()
...
// UnmarshalSSZ ssz unmarshals the SignedBeaconBlockEip4844 object
func (s *SignedBeaconBlockEip4844) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 100 {
		return ssz.ErrSize
...
// SizeSSZ returns the ssz encoded size in bytes for the SignedBeaconBlockEip4844 object
func (s *SignedBeaconBlockEip4844) SizeSSZ() (size int) {
	size = 100
...
// HashTreeRoot ssz hashes the SignedBeaconBlockEip4844 object
func (s *SignedBeaconBlockEip4844) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(s)
}

// HashTreeRootWith ssz hashes the SignedBeaconBlockEip4844 object with a hasher
func (s *SignedBeaconBlockEip4844) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
...
// MarshalSSZ ssz marshals the BeaconBlockEip4844 object
func (b *BeaconBlockEip4844) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(b)
}

// MarshalSSZTo ssz marshals the BeaconBlockEip4844 object to a target array
func (b *BeaconBlockEip4844) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(84)
	...
	dst = ssz.WriteOffset(dst, offset)
	if b.Body == nil {
		b.Body = new(BeaconBlockBodyEip4844)
	}
	offset += b.Body.SizeSSZ()
...
// UnmarshalSSZ ssz unmarshals the BeaconBlockEip4844 object
func (b *BeaconBlockEip4844) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 84 {
		return ssz.ErrSize
...
// SizeSSZ returns the ssz encoded size in bytes for the BeaconBlockEip4844 object
func (b *BeaconBlockEip4844) SizeSSZ() (size int) {
	size = 84
...
// HashTreeRoot ssz hashes the BeaconBlockEip4844 object
func (b *BeaconBlockEip4844) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(b)
}

// HashTreeRootWith ssz hashes the BeaconBlockEip4844 object with a hasher
func (b *BeaconBlockEip4844) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
...
// MarshalSSZ ssz marshals the BeaconBlockBodyEip4844 object
func (b *BeaconBlockBodyEip4844) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(b)
}

// MarshalSSZTo ssz marshals the BeaconBlockBodyEip4844 object to a target array
func (b *BeaconBlockBodyEip4844) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(388)
...
// UnmarshalSSZ ssz unmarshals the BeaconBlockBodyEip4844 object
func (b *BeaconBlockBodyEip4844) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 388 {
		return ssz.ErrSize
...
// SizeSSZ returns the ssz encoded size in bytes for the BeaconBlockBodyEip4844 object
func (b *BeaconBlockBodyEip4844) SizeSSZ() (size int) {
	size = 388
...
// HashTreeRoot ssz hashes the BeaconBlockBodyEip4844 object
func (b *BeaconBlockBodyEip4844) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(b)
}

// HashTreeRootWith ssz hashes the BeaconBlockBodyEip4844 object with a hasher
func (b *BeaconBlockBodyEip4844) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
